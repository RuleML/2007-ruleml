...
/**
 * Gallery SVN info
 * $Id: htmlMimeMail.php 15794 2007-02-09 14:24:10Z jenst $
*/

/**
 * Filename.......: class.html.mime.mail.inc
 * Project........: HTML Mime mail class
 * Last Modified..: $Date: 2007-02-09 09:24:10 -0500 (Fri, 09 Feb 2007) $
 * CVS Revision...: $Revision: 15794 $
		...
		switch ($type) {
			...
			case 'smtp':
				...
				if (!$smtp->send($send_params)) {
					...
					echo gallery_error(_("Sending mail via the smtp method failed with these errors:"));
					print_r($smtp->errors);
					return false;
				}
				return true;
